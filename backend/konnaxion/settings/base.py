...
MIDDLEWARE = [
    # "django.middleware.security.SecurityMiddleware",  # handled by WhiteNoise
...
# WhiteNoise - see https://whitenoise.evans.io/en/stable/django.html
...
# Keep this disabled in base; enable in production only.
SECURE_SSL_REDIRECT = False
# HSTS only in production settings; left out here deliberately.
...
from .settings_addons import (  # noqa: E402
    EKOH_INSTALLED_APPS,
